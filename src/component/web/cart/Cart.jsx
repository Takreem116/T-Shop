...
if (isLoading){
  ...
  return (
    ...
    <div className="container">
      ...
      <h2 className='cart-titel pt-5'> Cart Information</h2>
      <div className="row">
        <div className="cart-items">
          <div className="products" id="products">
            <div className="item">
              <div className="product-info">
                <h2 className='item-style' >Product</h2>
              </div>
              <div className="quantity">
                <h2 className='item-style'>Quantity</h2>
              </div>
              <div className="price">
                <h2 className='item-style'>Price</h2>
              </div>
              <div className="subtotal">
                <h2 className='item-style'>Subtotal</h2>
              </div>
            </div>
...
No Products Avaliable Now .. </h2>}
            

<button  className='btn clearCart   text-white w-25' onClick={clearcart}> Clear Cart </button>
